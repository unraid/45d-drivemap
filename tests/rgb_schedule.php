...
schedule_check(homelab_power_toggle($press)['ok'] && $button[0] === ['off', null],
  'power button turns current lighting off');
schedule_check(homelab_power_toggle($press)['ok'] &&
  $button[1] === ['on', ['kind' => 'global', 'preset' => 'blue']],
  'next power button press restores last daytime lighting');
